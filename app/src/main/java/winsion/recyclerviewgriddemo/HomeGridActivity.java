...
public class HomeGridActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 8; i++) {
            if (i == 0) {
                mList.add(new HomeGrid(HomeGridAdapter.TYPE_LONG, R.mipmap.ic_launcher, null, -1));
            } else if (i == 5) {
    ...
    class HomeGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_LONG || viewType == TYPE_NORMAL_IMG) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (type == TYPE_LONG || type == TYPE_NORMAL_IMG) {
